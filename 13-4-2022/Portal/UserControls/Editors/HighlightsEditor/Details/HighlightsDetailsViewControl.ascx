<%@ Control AutoEventWireup="True" CodeBehind="HighlightsDetailsViewControl.ascx.cs"
     Inherits="MnfUniversity_Portals.UserControls.Editors.HighlightsEditor.Details.HighlightsDetailsViewControl"
    Language="C#" %>
