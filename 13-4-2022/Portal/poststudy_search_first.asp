...
<!--#include file="global/SyncSearch_poststudy.asp" -->	
...
facultyset.open " Select * from FacultyTable order by FacultyID   ",DataBaseConectionpost,1,3,1
deptset.open " Select * from Department      ",DataBaseConectionpost,1,3,1
 

%>
<center><br />
<p class=phead><u> رسائل الدكتوراة والماجستير</u></p>
<br />
</center>
 
<table     height="276" width="360" cellpadding=0 cellspacing=0  border=0 dir=rtl align=center>
 <FORM action="search_poststudy.asp" method=POST id=send_to_friend name=send_to_friend onsubmit="return valid(this);">
