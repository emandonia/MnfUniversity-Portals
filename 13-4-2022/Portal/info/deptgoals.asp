...
dbdeptrs6.Open "select * from deptgoals where dept_id ='"&id&"' order by g_id",DataBaseConection,1,3,1
...
<span style="background-color: #FFFF99">√Âœ«› «·≈œ«—…
</span>
  ...
  <% for i=fcont to 2  step-1%> 
   ...
   <td   align=right >
      <P style="text-align: justify; text-justify: kashida; line-height: 150%">
       <font color=#ffffff> <b><FONT size=3 face=tarnsparntarabic>-&nbsp;<%=dbdeptrs6(i)%> </FONT> <br /><br /></b></font>
      </P></td>
  <% next %> 
  </tr>
<% dbdeptrs6.MoveNext
