<%@ Page Title="محرر الطلاب" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ControlStudents.aspx.cs" Inherits="AnnualYouthWeekWebApplication.UI.ControlStudents" %>
        ...
        <ContentTemplate>
            ...
            <%--<asp:DynamicDataManager ViewStateMode="Enabled"  ID="DynamicDataManager1" runat="server"/>--%>
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td>من فضلك اختر النشاط: </td>
                        <td><asp:DropDownList ID="DropDownList5" AutoPostBack="True" OnSelectedIndexChanged="DropDownList5_OnSelectedIndexChanged"  runat="server" DataSourceID="LinqDataSource222" DataTextField="Activity_Name" DataValueField="ID"></asp:DropDownList>
                            <asp:LinqDataSource runat="server" EntityTypeName="" ID="LinqDataSource222" ContextTypeName="AnnualYouthWeekWebApplication.MyDataContext" Select="new (ID, Activity_Name)" TableName="Activities"></asp:LinqDataSource>
</td>
                    ...
                    <ItemTemplate>
                       ...
                       <%-- <asp:Image ID="DeleteImage" ImageUrl='<%# DeleteImageURL %>' CssClass="NoMargin"
                        ...
                        <%--<asp:Image ID="EditImage" ImageUrl='<%# EditImageURL %>' CssClass="NoMargin" runat="server"></asp:Image>--%>
                            ...
                            <asp:Label Text='<%# Eval("SerialNo") %>' runat="server" ID="Label3" />
                            </td>
                            <td>
                                <asp:HiddenField runat="server" ID="FilterValueControl" Value='<%# Bind("ID") %>' />
                                <asp:Label Text='<%# Eval("Stu_Name") %>' runat="server" ID="Gen_Inst_NameLabel" />
                            </td>
                            
                            <td>
                                <asp:Label Text='<%# StudentsUtilty.getcurrentFac(Convert.ToInt32(Eval("ID"))) %>' runat="server" ID="General_inst_typeLabel" /></td>
                           <td>
                                <asp:Label Text='<%# StudentsUtilty.getcurrentyear(Convert.ToInt32(Eval("ID"))) %>' runat="server" ID="Label2" /></td>
                            <td>
                                <asp:Label Text='<%# StudentsUtilty.getcurrentact(Convert.ToInt32(Eval("ID"))) %>' runat="server" ID="Label4" /></td>
                            <td>
                                <asp:Label Text='<%# StudentsUtilty.getcurrentField(Convert.ToInt32(Eval("ID"))) %>' runat="server" ID="Label5" /></td>
                                ...
                                <td runat="server">
                                     <table runat="server" id="itemPlaceholderContainer" style="width: 100%;background-color: #FFFFFF; border-collapse: collapse; border-color: #999999; border-style: none; border-width: 1px; font-family: Verdana, Arial, Helvetica, sans-serif;" border="1">
                                        <tr runat="server" style="background-color: #DCDCDC; color: #000000;">
                                            ...
                                            <th runat="server">الكلية</th>
                                           <th runat="server">الفرقة</th>
                                           <th runat="server">النشاط</th>
                                            <th runat="server">المجال</th>
            ...
            <asp:LinqDataSource runat="server" ID="LinqDataSource1" EntityTypeName="" ContextTypeName="AnnualYouthWeekWebApplication.MyDataContext"
                Select="new (ID, Stu_Name, National_ID, Gender, Birth_Date, Birth_Place, NatID_Image, Personal_Image, Address, Email, phone_no, Faculty_ID, University_id,SerialNo)" TableName="Students" Where="University_id == @University_id ">
                <WhereParameters>
