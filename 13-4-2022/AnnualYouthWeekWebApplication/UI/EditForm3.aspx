<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditForm3.aspx.cs" Inherits="AnnualYouthWeekWebApplication.UI.EditForm3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="server"><div style="width: 100%">
        <asp:DetailsView ID="DetailsView1" runat="server" style="width: 50%"  AutoGenerateRows="False" DataSourceID="LinqDataSource1">
         <Fields>
             <asp:TemplateField HeaderText="رقم الاستمارة">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtname3331" runat="server" Text='<%# Eval("SerialNo") %>'></asp:TextBox><asp:Label ID="Label3000" runat="server" Text="يجب ان يكون الرقم من 12 إلي 31 فقط"></asp:Label>
                ...
                <asp:Label ID="Label231" Text='<%# Eval("SerialNo") %>' runat="server" />
                            ...
                            <asp:TemplateField HeaderText="الاسم">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtname1" runat="server" Text='<%# Bind("Inst_Name") %>'></asp:TextBox>
                                ...
                                <ItemTemplate>
                <asp:Label ID="Label1" Text='<%# Bind("Inst_Name") %>' runat="server" />
            </ItemTemplate>
                            </asp:TemplateField>
             ...
             <asp:TemplateField HeaderText="النوع">
              ...
              <asp:TemplateField HeaderText="المجال">
                                <EditItemTemplate>
                                     <asp:DropDownList ID="DropDownList3541" SelectedValue='<%#InstructorsUtility.getfield(Convert.ToInt32(Eval("ID"))) %>'  AppendDataBoundItems="True" runat="server" DataSourceID="LinqDataSource53" DataTextField="Field_Name" DataValueField="ID"></asp:DropDownList>
                                    <asp:LinqDataSource runat="server" EntityTypeName="" ID="LinqDataSource53" ContextTypeName="AnnualYouthWeekWebApplication.MyDataContext" Select="new (ID, Field_Name)" TableName="Fields"></asp:LinqDataSource>


                                </EditItemTemplate>
                                 <ItemTemplate>
                 <asp:Label ID="Label3267" Text='<%# GetInsField(Eval("FieldID")) %>' runat="server" />
            </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="نوع المشرف">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList1" SelectedValue='<%#InstructorsUtility.getadmintype(Convert.ToInt32(Eval("ID"))) %>'  AppendDataBoundItems="True" runat="server" DataSourceID="LinqDataSource3" DataTextField="Inst_Type" DataValueField="ID"></asp:DropDownList>
                                    <asp:LinqDataSource runat="server" EntityTypeName="" ID="LinqDataSource3" ContextTypeName="AnnualYouthWeekWebApplication.MyDataContext" Select="new (Inst_Type, ID)" TableName="Instructor_Types"></asp:LinqDataSource>



                                </EditItemTemplate>
                                 <ItemTemplate>
                <asp:Label ID="Label32423" Text='<%# GetadminType(Eval("Inst_type")) %>' runat="server" />
            </ItemTemplate>
                            </asp:TemplateField>
    ...
    <asp:LinqDataSource runat="server" EntityTypeName="" ID="LinqDataSource1" ContextTypeName="AnnualYouthWeekWebApplication.MyDataContext"  Where="ID == @ID" Select="new (SerialNo,ID, Inst_Name, Inst_type, National_ID, Gender, Birth_Date, Birth_Place, NatID_Image, Personal_Image, Address, Email, phone_no,FieldID)" TableName="Instructors">
        <WhereParameters>
