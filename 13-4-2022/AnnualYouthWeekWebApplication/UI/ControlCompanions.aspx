<%@ Page Title="محرر المرافقين" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ControlCompanions.aspx.cs" Inherits="AnnualYouthWeekWebApplication.UI.ControlCompanions" %>
                       ...
                       <%-- <asp:Image ID="DeleteImage" ImageUrl='<%# DeleteImageURL %>' CssClass="NoMargin"
                        ...
                        <%--<asp:Image ID="EditImage" ImageUrl='<%# EditImageURL %>' CssClass="NoMargin" runat="server"></asp:Image>--%>
                            ...
                            <td>
                                ...
                                <asp:Label Text='<%# Eval("Comp_Name") %>' runat="server" ID="Gen_Inst_NameLabel" />
                            </td>
                            
                            <td>
                                <asp:Label Text='<%# getadmintype2(Eval("Comp_type")) %>' runat="server" ID="General_inst_typeLabel" /></td>
                        </tr>
                    </ItemTemplate>
                    <LayoutTemplate>
