<%@ Page Title="تعديل" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditForm.aspx.cs" Inherits="AnnualYouthWeekWebApplication.UI.EditForm" %>
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" style="width: 50%"  AutoGenerateRows="False" DataSourceID="LinqDataSource1">
         <Fields>
             <asp:TemplateField HeaderText="رقم الاستمارة">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtname3331" runat="server" Text='<%# Eval("SerialNo") %>'></asp:TextBox><asp:Label ID="Label3000" runat="server" Text="يجب ان يكون الرقم من 1 إلي 3 فقط"></asp:Label>
                ...
                <asp:Label ID="Label231" Text='<%# Eval("SerialNo") %>' runat="server" />
                            ...
                            <asp:TemplateField HeaderText="الاسم">
                                ...
                                <ItemTemplate>
                <asp:Label ID="Label1" Text='<%# Bind("Admin_Name") %>' runat="server" />
            </ItemTemplate>
                            </asp:TemplateField>
                ...
                <asp:Label ID="Label2" Text='<%# Bind("National_ID") %>' runat="server" />
                             ...
                             <asp:TemplateField HeaderText="رقم التليفون">
                               ...
                               <ItemTemplate>
                <asp:Label ID="Label6" Text='<%# Bind("Phone_Number") %>' runat="server" />
            </ItemTemplate>
                            </asp:TemplateField>
                ...
                <asp:Label ID="Label333" Text='<%# Bind("Email") %>' runat="server" />
                            ...
                            <asp:TemplateField HeaderText="الصورة الشخصية">
                                <EditItemTemplate>
                                  <ajaxtk:AsyncFileUpload ID="AsyncFileUpload1" ThrobberID="imgLoader" Width="70px" runat="server" OnUploadedComplete="AsyncFileUpload1_UploadedComplete"  />
                                    
&nbsp;&nbsp; <asp:Image ID="imgLoader" runat="server" ImageUrl = "../Images/loader.gif"/> 
                                </EditItemTemplate>
                                 <ItemTemplate>
                                     <a id="example1" href='<%# GetpImagePath(Eval("Personal_Image")) %>'><img width="150px" height="150px" alt="example1" src='<%# GetpImagePath(Eval("Personal_Image")) %>' /></a>
                           ...
                           <%-- <asp:TemplateField HeaderText="صورة الرقم القومي">
                                ...
                                <ItemTemplate>
                                    <a id="example1" href='<%# GetnImagePath(Eval("NatID_Image")) %>'><img width="150px" height="150px" alt="example1" src='<%# GetnImagePath(Eval("NatID_Image")) %>' /></a>
                            ...
                            <asp:TemplateField HeaderText="نوع القائد">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="DropDownList2" SelectedValue='<%# HigherAdminsUtility.getadmintype(Convert.ToInt32(Eval("ID")))%>' AppendDataBoundItems="True" runat="server" DataSourceID="LinqDataSource3"  DataTextField="Admin_Type" DataValueField="ID"></asp:DropDownList>
                                 ...
                                 <ItemTemplate>
                <asp:Label ID="Label32423" Text='<%# GetadminType(Eval("Admin_type_id")) %>' runat="server" />
            </ItemTemplate>
                            </asp:TemplateField>
    ...
    <asp:LinqDataSource runat="server" EntityTypeName="" ID="LinqDataSource1" ContextTypeName="AnnualYouthWeekWebApplication.MyDataContext" Select="new (SerialNo,ID,Admin_Name, National_ID, Phone_Number, Birth_Date, Birth_Place, Address, Email, Personal_Image,Admin_type_id)" TableName="Higher_Admins" Where="ID == @ID">
        <WhereParameters>
