<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InsertForm6.aspx.cs" Inherits="AnnualYouthWeekWebApplication.UI.InsertForm6" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
      <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
        ...
        <ContentTemplate>
                    ...
                    <asp:DetailsView ID="Editor_DetailsView1" DataKeyNames="ID" CssClass="Editor_DetailsView" Style="background-color: #cccccc" runat="server"
                        ...
                        <Fields>
                            <asp:TemplateField HeaderText="رقم الاستمارة">
                                ...
                                <InsertItemTemplate>
                                    <asp:TextBox ID="txtnamee" Text='<%# Eval("SerialNo") %>' runat="server"></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="الاسم">
                                ...
                                <InsertItemTemplate>
                                    <asp:TextBox ID="txtname" Text='<%# Bind("Member_Name") %>' runat="server"></asp:TextBox>
            ...
            <asp:LinqDataSource runat="server" ID="LinqDataSource1" EntityTypeName="" ContextTypeName="AnnualYouthWeekWebApplication.MyDataContext" TableName="Members" Where="University_id == @University_id">
                    <WhereParameters>
                        <asp:SessionParameter SessionField="UniID" Name="University_id" Type="Int32" DefaultValue="3"></asp:SessionParameter>
                    </WhereParameters>
                </asp:LinqDataSource>
        </ContentTemplate>
    </asp:UpdatePanel>
