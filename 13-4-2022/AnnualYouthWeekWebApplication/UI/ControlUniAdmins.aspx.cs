...
{
    public partial class ControlUniAdmins : System.Web.UI.Page
    {
        ...
        protected void Editor_ImageButton_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("EditForm.aspx?ID="+Session["ID"] );
        ...
        protected void ArticleEditorControlInsertClicked(object sender, EventArgs e)
        {
            ...
            Response.Redirect("InsertForm1.aspx");
        }
...
HigherAdminsUtility.DeleteAdmin(Convert.ToInt32(Session["ID"]));
            ListView1.DataBind();
