<%@ Page Title="محرر المشرفين" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ControlInst.aspx.cs" Inherits="AnnualYouthWeekWebApplication.UI.ControlInst" %>
                       ...
                       <%-- <asp:Image ID="DeleteImage" ImageUrl='<%# DeleteImageURL %>' CssClass="NoMargin"
                        ...
                        <%--<asp:Image ID="EditImage" ImageUrl='<%# EditImageURL %>' CssClass="NoMargin" runat="server"></asp:Image>--%>
                            ...
                            <td>
                                ...
                                <asp:Label Text='<%# Eval("Inst_Name") %>' runat="server" ID="Gen_Inst_NameLabel" />
                            </td>
                            
                            <td>
                                <asp:Label Text='<%# getadmintype2(Eval("Inst_type")) %>' runat="server" ID="General_inst_typeLabel" /></td>
                        </tr>
                    </ItemTemplate>
                    <LayoutTemplate>
