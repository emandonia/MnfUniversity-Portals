...
{
    public partial class GenInstRpt : System.Web.UI.Page
    {
        ...
        protected void Button1_OnClick(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/UI/GenInstRpt.rdlc");
            if (!CheckBox1.Checked && DropDownList1.SelectedIndex != -1)
            {
                q1 = GeneralInstUtility.GetinstByuniname(DropDownList1.SelectedItem.Text);
            ...
            else
            {
                ...
                q1 = GeneralInstUtility.Getinsts();
