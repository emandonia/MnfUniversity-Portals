...
{
    public partial class ControlInst : System.Web.UI.Page
    {
        ...
        protected void Editor_ImageButton_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("EditForm3.aspx?ID=" + Session["ID"]);
        ...
        protected void ArticleEditorControlInsertClicked(object sender, EventArgs e)
        {
            ...
            Response.Redirect("InsertForm3.aspx");
        }
        ...
        protected void Delete_LinkButton_OnClick(object sender, EventArgs e)
        {
            ...
            InstructorsUtility.DeleteAdmin(Convert.ToInt32(Session["ID"]));
            ListView1.DataBind();
