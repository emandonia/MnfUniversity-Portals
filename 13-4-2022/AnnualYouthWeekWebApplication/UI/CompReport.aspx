<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CompReport.aspx.cs" Inherits="AnnualYouthWeekWebApplication.UI.CompReport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
     ...
     <h2 class="auto-style6">
               <strong>برجاء ادخال اسم المرافق رباعي او الضغط علي ابحث مباشرة لعرض بيانات كل مرافقين جامعتكم الموقرة . . . </strong> 
  ...
  style="display: none" runat="server" class="auto-style2"></iframe>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" AsyncRendering="False" Width="800px" Height="500px"  runat="server" SizeToReportContent="True" DocumentMapCollapsed="True" ZoomPercent="100" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
