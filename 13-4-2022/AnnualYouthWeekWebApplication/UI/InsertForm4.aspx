<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InsertForm4.aspx.cs" Inherits="AnnualYouthWeekWebApplication.UI.InsertForm4" %>
        ...
        <ContentTemplate>
                    ...
                    <asp:DetailsView ID="Editor_DetailsView1" DataKeyNames="ID"  CssClass="Editor_DetailsView" Style="background-color: #cccccc" runat="server"
                        ...
                        <Fields>
                            <asp:TemplateField HeaderText="رقم الاستمارة">
                                ...
                                <InsertItemTemplate>
                                    <asp:TextBox ID="txtnamee" Text='<%# Eval("SerialNo") %>' runat="server"></asp:TextBox><asp:Label ID="Label3000" runat="server" Text="يجب ان يكون الرقم من 32 إلي 39 فقط"></asp:Label>
                    ...
                    ValidationGroup="InsertGroup" ControlToValidate="InsertAsyncFileUpload1"></asp:RequiredFieldValidator>--%>
                            ...
                            <asp:TemplateField HeaderText="نوع المشرف">
                                ...
                                <InsertItemTemplate>
                                    ...
                                    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="LinqDataSource3" DataTextField="Comp_Type" DataValueField="ID"></asp:DropDownList>
                                    <asp:LinqDataSource runat="server" EntityTypeName="" ID="LinqDataSource3" ContextTypeName="AnnualYouthWeekWebApplication.MyDataContext" Select="new (ID, Comp_Type)" TableName="Companion_types"></asp:LinqDataSource>
            ...
            <br/>
                ...
                <asp:LinqDataSource runat="server" ID="LinqDataSource1" EntityTypeName="" ContextTypeName="AnnualYouthWeekWebApplication.MyDataContext" 
                    Select="new (ID, Comp_Name, Comp_type, National_ID, Gender, Birth_Date, Birth_Place, NatID_Image, Personal_Image, Address, Email, phone_no,SerialNo)" TableName="Companions" Where="University_id == @University_id">
                    <WhereParameters>
