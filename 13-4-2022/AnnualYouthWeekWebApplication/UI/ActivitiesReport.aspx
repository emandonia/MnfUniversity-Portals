<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ActivitiesReport.aspx.cs" Inherits="AnnualYouthWeekWebApplication.UI.ActivitiesReport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div style="font-size: xx-large !important;font-weight: bold !important">
      ...
      <table style="">
           <tr>
            <td class="auto-style3"><strong>اختر النشاط:</strong></td>
            <td>
                <strong>
                <asp:DropDownList ID="DropDownList2" runat="server" AppendDataBoundItems="True" DataSourceID="LinqDataSource2" DataTextField="Activity_Name" DataValueField="ID" CssClass="auto-style2">

                    <asp:ListItem Value="-1">اختر</asp:ListItem>
                </asp:DropDownList></strong><asp:LinqDataSource runat="server" EntityTypeName="" ID="LinqDataSource2" ContextTypeName="AnnualYouthWeekWebApplication.MyDataContext" Select="new (Activity_Name, ID)" TableName="Activities">
                    
                </asp:LinqDataSource> <span class="auto-style2"><strong>&nbsp; &nbsp;</strong></span><strong><asp:CheckBox ID="CheckBox2" AutoPostBack="True" Text="كل الانشطة" OnCheckedChanged="CheckBox2_OnCheckedChanged" runat="server" CssClass="auto-style2" />
                </strong>
            </td>
  ...
  style="display: none" runat="server" class="auto-style2"></iframe>
    ...
    <div style="overflow: scroll"> <rsweb:ReportViewer ID="ReportViewer1" ShowPrintButton="True" AsyncRendering="False" Width="800px" Height="500px" runat="server" SizeToReportContent="True" DocumentMapCollapsed="True" ZoomPercent="100" Font-Names="Verdana" Font-Size="10pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
