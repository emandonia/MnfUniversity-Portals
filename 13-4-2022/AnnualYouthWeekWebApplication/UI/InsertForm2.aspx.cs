...
{
    public partial class InsertForm2 : System.Web.UI.Page
    {
        ...
        protected void InsertButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                GeneralInstUtility.insertGeneralInst(serialno.Text, name.Text, nid.Text, bd.Text, Convert.ToBoolean(att.SelectedValue), bp.Text,
