<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ControlMembers.aspx.cs" Inherits="AnnualYouthWeekWebApplication.UI.ControlMembers" %>
                       ...
                       <%-- <asp:Image ID="DeleteImage" ImageUrl='<%# DeleteImageURL %>' CssClass="NoMargin"
                        ...
                        <%--<asp:Image ID="EditImage" ImageUrl='<%# EditImageURL %>' CssClass="NoMargin" runat="server"></asp:Image>--%>
                            ...
                            <td>
                                ...
                                <asp:Label Text='<%# Eval("Member_Name") %>' runat="server" ID="Gen_Inst_NameLabel" />
                            </td>
