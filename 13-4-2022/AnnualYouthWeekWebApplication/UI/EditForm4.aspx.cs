...
{
    public partial class EditForm4 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Convert.ToString(Session["source"]) == "edit")
            {
                ...
                //at.SelectedValue = CompanionsUtilty.getadmintype(Convert.ToInt32(Session["ID"]));
        ...
        protected string getgender(int id)
        {
            ...
            if (CompanionsUtilty.getadmingender3(id))
            {
                return "true";
            }
            else { return "false"; }
        ...
        protected void LinkButton1_OnClick(object sender, EventArgs e)
        {
            ...
            if (aa.HasFile && !aa2.HasFile)
            {
                ...
                CompanionsUtilty.UpdateHigherAdmin(Convert.ToInt32(serialno.Text), Convert.ToInt32(Session["ID"]), name.Text, nid.Text, bd.Text, bp.Text, Convert.ToBoolean(att.SelectedValue), phno.Text, add.Text, em.Text, (string)Session["pi"], null, at.SelectedValue);

            }
            else if (!aa.HasFile && aa2.HasFile)
            {

                CompanionsUtilty.UpdateHigherAdmin(Convert.ToInt32(serialno.Text), Convert.ToInt32(Session["ID"]), name.Text, nid.Text, bd.Text, bp.Text, Convert.ToBoolean(att.SelectedValue), phno.Text, add.Text, em.Text, null, (string)Session["ni"], at.SelectedValue);

            }
            else if (aa.HasFile && aa2.HasFile)
            {

                CompanionsUtilty.UpdateHigherAdmin(Convert.ToInt32(serialno.Text), Convert.ToInt32(Session["ID"]), name.Text, nid.Text, bd.Text, bp.Text, Convert.ToBoolean(att.SelectedValue), phno.Text, add.Text, em.Text, (string)Session["pi"], (string)Session["ni"], at.SelectedValue);

            }
            else
            {
                CompanionsUtilty.UpdateHigherAdmin(Convert.ToInt32(serialno.Text), Convert.ToInt32(Session["ID"]), name.Text, nid.Text, bd.Text, bp.Text, Convert.ToBoolean(att.SelectedValue), phno.Text, add.Text, em.Text, null, null, at.SelectedValue);
