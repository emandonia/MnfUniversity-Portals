<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditForm6.aspx.cs" Inherits="AnnualYouthWeekWebApplication.UI.EditForm6" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="server"><div style="width: 100%">
     <asp:DetailsView ID="DetailsView1" runat="server" style="width: 50%"  AutoGenerateRows="False" DataSourceID="LinqDataSource1">
         <Fields>
             <asp:TemplateField HeaderText="رقم الاستمارة">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtname3331" runat="server" Text='<%# Eval("SerialNo") %>'></asp:TextBox>
                ...
                <asp:Label ID="Label231" Text='<%# Eval("SerialNo") %>' runat="server" />
                            ...
                            <asp:TemplateField HeaderText="الاسم">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtname1" runat="server" Text='<%# Bind("Member_Name") %>'></asp:TextBox>
                                ...
                                <ItemTemplate>
                <asp:Label ID="Label1" Text='<%# Bind("Member_Name") %>' runat="server" />
            </ItemTemplate>
                            </asp:TemplateField>
    ...
    <asp:LinqDataSource runat="server" EntityTypeName="" ID="LinqDataSource1" ContextTypeName="AnnualYouthWeekWebApplication.MyDataContext" Where="ID == @ID" TableName="Members">
        <WhereParameters>
