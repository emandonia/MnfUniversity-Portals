 ...
 <table border=0 width=100% cellpadding=0 cellspacing=0 align=right>
    <tr>
        <td colspan=2 align=center>
            <b> <FONT color=#FFFFff size=5  face=tarnsparntarabic> 
<%
...
<TABLE   cellSpacing=0  cellPadding=0 border=0   align=right  style="WIDTH: 288px; HEIGHT: 126px"  >
<tr  >
 <td   colspan=3 valign="top" height="30">
  <p dir="rtl" align="right">
      <b><u><FONT color="#FFFF66" size=4 face="tarnsparnt arabic">
         ÂÌﬂ· «·≈œ«—…   </FONT> </u> </b> </p>
     </td>
  </tr>
 <%
...
%>
<tr><td align=left colspan=2><A href="depthierarchy.asp?dept=<%=id%>" target=_top style="color:yellow">··„“Ìœ...</A></td></tr>
</TABLE>
        </td>
        <td valign=top>
        <%
...
<TABLE   cellSpacing=1  cellPadding=0   align=left  style="WIDTH: 254px; HEIGHT: 78px" border="0">
...
%>
<tr><td align=left colspan=2><A href="deptmessage.asp?dept=<%=id%>" target=_top style="color:yellow">··„“Ìœ...</A></td></tr>
...
<TABLE  bordercolor=silver  cellSpacing=2  cellPadding=1   align=right  border=0  width=262 style="WIDTH: 262px; HEIGHT: 106px">
<tr>
<td  align=right valign="top" >
<b><u><FONT color="#FFFF66"  size=4 face="tarnsparnt arabic">
 √Âœ«› «·≈œ«—…
...
%>
<tr><td align=left colspan=2><A href="deptgoals.asp?dept=<%=id%>" target=_top style="color:yellow">··„“Ìœ...</A></td></tr>
...
<TABLE   cellSpacing=1  cellPadding=0   align=left  style="WIDTH: 254px; HEIGHT: 111px" border="0">
...
%>
<tr><td align=left colspan=2><A href="deptservices.asp?dept=<%=id%>" target=_top style="color:yellow">··„“Ìœ...</A></td></tr>
</TABLE>
        </td>
    </tr>
     <tr>
...
%>
 <%
  ...
  %>
<tr><td align=left colspan=2><A href="deptachieve.asp?dept=<%=id%>" target=_top style="color:yellow">··„“Ìœ...</A></td></tr>
...
%>
<tr><td align=left colspan=2><A href="deptfutureplane.asp?dept=<%=id%>" target=_top style="color:yellow">··„“Ìœ...</A></td></tr>
