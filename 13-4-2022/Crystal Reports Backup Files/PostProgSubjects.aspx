<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpages/UniversityMaster.Master" AutoEventWireup="true" CodeBehind="PostProgSubjects.aspx.cs" Inherits="MnfUniversity_Portals.UI.PostProgSubjects" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
 ...
 <tr > <div style="width: 100%">
                           <td class="col1"> <asp:Label ID="Label8" runat="server" Text='<%#Eval("SUBJECT_CODE")%>'></asp:Label></td>
                                            ...
                                            <td class="col2">
                               <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="blue" NavigateUrl='<%#getSubjectUrl(Eval("PG_SUBJECT_ID"))%>'
     ...
     <td class="col1"> <asp:Label ID="Label7" runat="server" Text='<%#Eval("SUBJECT_DESCR_EN")%>'></asp:Label></td>
                           <td class="col3"> <asp:Label ID="Label6" runat="server" Text='<%# MnfUniversity_Portals.BLL.MIS_BLL.PostSubject_Utility.GetSubjectYear(Convert.ToDecimal(Eval("PG_SUBJECT_ID")))%>'></asp:Label></td>
