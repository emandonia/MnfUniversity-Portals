<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpages/SpecialUnitsMaster.Master" AutoEventWireup="true" CodeBehind="CourseReportes.aspx.cs" Inherits="MnfUniversity_Portals.UI.Admin.CourseReportes" %>
        ...
        <tr>
            ...
            <td>
             ...
             <td>
                ...
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="Portal_DAL.PortalDataContextDataContext" EntityTypeName="" TableName="Prtl_Courses">
                </asp:LinqDataSource>
            </td>
            <td></td>
        </tr>
