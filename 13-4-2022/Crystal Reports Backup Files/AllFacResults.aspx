...
<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpages/UniversityMaster.Master" AutoEventWireup="true" CodeBehind="AllFacResults.aspx.cs" Inherits="MnfUniversity_Portals.UI.AllFacResults" %>
                ...
                <table class="staffsearchtable" style="width: 900px;">
                    ...
                    <asp:TextBox ID="nidTextBox1" runat="server"></asp:TextBox>&nbsp;&nbsp;
                        ...
                        <td id="acidtd" runat="server" visible="false" class="auto-style3">
                            <asp:Label ID="Label3" runat="server" Text="Seat Number :" meta:resourcekey="seatid"></asp:Label>
                            &nbsp;&nbsp;
