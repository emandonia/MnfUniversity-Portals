...
dim sql 
    sql="SELECT DISTINCT MainData.ArabicAddress,MainData.Faculty, MainData.PaperId, MainData.MainResName, Mid(MainData.Summary,1,300) AS summ  "&_
...
sql=sql&";" 
 'response.Write sql
'response.End 
         newset.open sql,DataBaseConectionoutstand,1,3,1
	  ...
	  <%
		...
		'*********************************Drawing search result***********************
			  ...
			  href="outpaperDetails.asp?id="& newset(2)
