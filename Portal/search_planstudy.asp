...
sql=sql&";" 
'response.Write sql
          newset.open sql,DataBaseConectionplan,1,3,1
        
	%>
	 <center><font face=" imes new roman" size=5><b>    الخطة البحثية لرسائل <br />الماجستير و الدكتوراة     </b></font><br />     </center>
	...
	<%  
        ...
        Response.Write "<center><font face=Arial size=3 color=darkred>"
         ...
         response.Write "عدد الخطط البحثية المطابقة"
         response.Write "</u>"
			  response.Write "&nbsp;&nbsp;&nbsp;&nbsp; <font color=firebrick>"
response.Write a
response.Write "&nbsp;"
response.Write "   دكتوراة"
 response.Write "&nbsp;/&nbsp;"
response.Write b
response.Write "&nbsp;"
response.Write "  ماجسيتر "
response.Write "</font>"
'response.Write "خطة بحثية"
		...
		'*********************************Drawing search result***********************
			  ...
			  href="planDetails.asp?id="& newset(2)
...
%>
								[<A href="search_planstudy.asp?m_nPageIndex=<%=i%>"><%=i%></A>]
	 <%		 		    else
