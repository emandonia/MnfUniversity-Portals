...
namespace BLL
{
    ...
    {
        private static PortalDataContextDataContext datc
        {
            get { return new PortalDataContextDataContext();  }
        }
        ...
        {
            return new PortalDataContextDataContext().prtl_Owners.FirstOrDefault(x => x.Abbr.ToLower() == abbr).InitAbbr;
        ...
        public static int GetTypeByAbbr(string abbr)
        {
            return new PortalDataContextDataContext().prtl_Owners.SingleOrDefault(x => x.Abbr.ToLower() == abbr).Type;
        }
