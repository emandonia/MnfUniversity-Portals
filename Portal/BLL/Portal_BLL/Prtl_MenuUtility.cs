...
namespace BLL
{
    public static class Prtl_MenuUtility
    {
        static void DeleteMenuItem(int menu_ID, string abbr)
        {
            ...
            {
                var item = dc.prtl_menu_medias.Single(m => m.Menu_id == menu_ID);

                dc.prtl_menu_medias.DeleteOnSubmit(item);
                var menuarticles = dc.prtl_Articles.Where(a => a.MenuItemId == menu_ID && a.Owner_ID == Prtl_OwnersUtility.GetOwnerIDByAbbr(abbr));
                foreach (var menuarticle in menuarticles)
                    menuarticle.MenuItemId = null;
                dc.SubmitChanges();
            ...
            {
                var item = dc.prtl_menu_AIs.Single(m => m.Menu_id == menu_ID);

                dc.prtl_menu_AIs.DeleteOnSubmit(item);
                var menuarticles = dc.prtl_Articles.Where(a => a.MenuItemId == menu_ID && a.Owner_ID == Prtl_OwnersUtility.GetOwnerIDByAbbr(abbr));
                foreach (var menuarticle in menuarticles)
                    menuarticle.MenuItemId = null;
                dc.SubmitChanges();
            ...
            {
                var item = dc.prtl_menu_dents.Single(m => m.Menu_id == menu_ID);

                dc.prtl_menu_dents.DeleteOnSubmit(item);
                var menuarticles = dc.prtl_Articles.Where(a => a.MenuItemId == menu_ID && a.Owner_ID == Prtl_OwnersUtility.GetOwnerIDByAbbr(abbr));
                foreach (var menuarticle in menuarticles)
                    menuarticle.MenuItemId = null;
                dc.SubmitChanges();
        ...
        //13-4-2022
        public static void Delete_ai_MenuItemAndSubItems(prtl_menu_AI menuitem, bool deletemenuitem)
        {
            string abbr = (string)System.Web.HttpContext.Current.Session["owner_abbr"];
            Delete_ai_SubItems(menuitem, abbr);
            Prtl_TranslationUtility.DeleteTranslations(menuitem.Translation_ID, abbr);
            if (deletemenuitem)
                DeleteMenuItem(menuitem.Menu_id, abbr);
        }
        ...
        //16-2022
        public static void Delete_dent_MenuItemAndSubItems(prtl_menu_dent menuitem, bool deletemenuitem)
        {
            string abbr = (string)System.Web.HttpContext.Current.Session["owner_abbr"];
            Delete_dent_SubItems(menuitem, abbr);
            Prtl_TranslationUtility.DeleteTranslations(menuitem.Translation_ID, abbr);
            if (deletemenuitem)
                DeleteMenuItem(menuitem.Menu_id, abbr);
        }
        ...
        //13-4-2022
        static void Delete_ai_SubItems(prtl_menu_AI menuitem, string abbr)
        {
            if (menuitem == null)
                return;
            foreach (var submenu in menuitem.prtl_menu_AIs)
            {
                Delete_ai_SubItems(submenu, abbr);
                Prtl_TranslationUtility.DeleteTranslations(submenu.Translation_ID, abbr);
                DeleteMenuItem(menuitem.Menu_id, abbr);
            }
        ...
        //16-6-2022
        static void Delete_dent_SubItems(prtl_menu_dent menuitem, string abbr)
        {
            if (menuitem == null)
                return;
            foreach (var submenu in menuitem.prtl_menu_dents)
            {
                Delete_dent_SubItems(submenu, abbr);
                Prtl_TranslationUtility.DeleteTranslations(submenu.Translation_ID, abbr);
                DeleteMenuItem(menuitem.Menu_id, abbr);
            }
        ...
        //13-4-2022
        public static IEnumerable<prtl_menu_AI> Get_ai_DBMenuItems(Guid? currentOwnerID)
        {
            return new PortalDataContextDataContext().prtl_menu_AIs.Where(m => m.Owner_ID.Equals(currentOwnerID));
        }
        ...
        //16-6-2022
        public static IEnumerable<prtl_menu_dent> Get_dent_DBMenuItems(Guid? currentOwnerID)
        {
            return new PortalDataContextDataContext().prtl_menu_dents.Where(m => m.Owner_ID.Equals(currentOwnerID));
        }
        //12121212//12121212
        ...
        //13-4-2022
        public static prtl_menu_AI Get_ai_MenuByID(int menu_ID)
        {
            return new PortalDataContextDataContext().prtl_menu_AIs.SingleOrDefault(m => m.Menu_id == menu_ID);
        }
        ...
        //16-2022
        public static prtl_menu_dent Get_dent_MenuByID(int menu_ID)
        {
            return new PortalDataContextDataContext().prtl_menu_dents.SingleOrDefault(m => m.Menu_id == menu_ID);
        }
        //12121212
        ...
        //13-4-2022
        public static prtl_menu_AI Get_ai_MenuByTranslationID(string translationID)
        {
            return new PortalDataContextDataContext().prtl_menu_AIs.SingleOrDefault(m => m.Translation_ID.ToString() == translationID);
        }
        ...
        //16-6-2022
        public static prtl_menu_dent Get_dent_MenuByTranslationID(string translationID)
        {
            return new PortalDataContextDataContext().prtl_menu_dents.SingleOrDefault(m => m.Translation_ID.ToString() == translationID);
        }
        //12121212//12121212
        ...
        public static object GetMenuIDs(Guid t_ID, Guid? ownerID, string currentlang, string position, string abbr)
        {
            ...
            {
                var prtlMenuComTran = dc.prtl_menu_media_trans.SingleOrDefault(
                    x => x.Translation_ID == t_ID && x.prtl_Language.LCID == currentlang);
                if (prtlMenuComTran != null)
                {
                    var menu_ID =
                        prtlMenuComTran.prtl_menu_media.Menu_id;
                    return dc.prtl_menu_media_trans
                        .Where(m => m.prtl_menu_media.Position == position && m.prtl_menu_media.Menu_id != menu_ID && m.prtl_menu_media.Owner_ID.Equals(ownerID) && m.prtl_Language.LCID == currentlang)
                        .Select(tr => new { tr.prtl_menu_media.Menu_id, tr.Translation_Data }).OrderBy(t => t.Translation_Data).ToList();
                }
                else
                {
                    return -1;
            ...
            {
                var prtlMenuaiTran = dc.prtl_menu_AI_trans.SingleOrDefault(
                    x => x.Translation_ID == t_ID && x.prtl_Language.LCID == currentlang);
                if (prtlMenuaiTran != null)
                {
                    var menu_ID =
                        prtlMenuaiTran.prtl_menu_AI.Menu_id;
                    return dc.prtl_menu_AI_trans
                        .Where(m => m.prtl_menu_AI.Position == position && m.prtl_menu_AI.Menu_id != menu_ID && m.prtl_menu_AI.Owner_ID.Equals(ownerID) && m.prtl_Language.LCID == currentlang)
                        .Select(tr => new { tr.prtl_menu_AI.Menu_id, tr.Translation_Data }).OrderBy(t => t.Translation_Data).ToList();
                }
                else
                {
                    return -1;
            ...
            {
                var prtlMenuComTran = dc.prtl_menu_dent_trans.SingleOrDefault(
                    x => x.Translation_ID == t_ID && x.prtl_Language.LCID == currentlang);
                if (prtlMenuComTran != null)
                {
                    var menu_ID =
                        prtlMenuComTran.prtl_menu_dent.Menu_id;
                    return dc.prtl_menu_dent_trans
                        .Where(m => m.prtl_menu_dent.Position == position && m.prtl_menu_dent.Menu_id != menu_ID && m.prtl_menu_dent.Owner_ID.Equals(ownerID) && m.prtl_Language.LCID == currentlang)
                        .Select(tr => new { tr.prtl_menu_dent.Menu_id, tr.Translation_Data }).OrderBy(t => t.Translation_Data).ToList();
                }
                else
                {
                    return -1;
        ...
        public static IEnumerable<string> GetUniquePositions(Guid? ownerID)
        {
            ...
            {
                return new PortalDataContextDataContext().prtl_menu_medias.Where(m => m.Owner_ID.GetValueOrDefault(Guid.Empty) ==
                    ownerID.GetValueOrDefault(Guid.Empty)).Select(m => m.Position).Distinct().ToList();
            }
            //14-4-2022
            else if (abbr != null && (abbr.ToLower() == "ai" && type == 1))
            {
                return new PortalDataContextDataContext().prtl_menu_AIs.Where(m => m.Owner_ID.GetValueOrDefault(Guid.Empty) ==
                    ownerID.GetValueOrDefault(Guid.Empty)).Select(m => m.Position).Distinct().ToList();
            }
            //16-6-2022
            else if (abbr != null && (abbr.ToLower() == "dent" && type == 1))
            {
                return new PortalDataContextDataContext().prtl_menu_dents.Where(m => m.Owner_ID.GetValueOrDefault(Guid.Empty) ==
                    ownerID.GetValueOrDefault(Guid.Empty)).Select(m => m.Position).Distinct().ToList();
            }
            else
            {
 ...
 ,
                    TitleFr = s.prtl_menu_univ_trans.SingleOrDefault(t => t.prtl_Language.LCID.ToLower() == "fr").Translation_Data
                    ,
                    TitleDe = s.prtl_menu_univ_trans.SingleOrDefault(t => t.prtl_Language.LCID.ToLower() == "de").Translation_Data
                    ,

                    TitleJa = s.prtl_menu_univ_trans.SingleOrDefault(t => t.prtl_Language.LCID.ToLower() == "ja").Translation_Data
                     ,
                    TitleTr = s.prtl_menu_univ_trans.SingleOrDefault(t => t.prtl_Language.LCID == "tr").Translation_Data
 ,
                    TitleFa = s.prtl_menu_univ_trans.SingleOrDefault(t => t.prtl_Language.LCID.ToLower() == "fa").Translation_Data
                    ,
                    TitleRu = s.prtl_menu_univ_trans.SingleOrDefault(t => t.prtl_Language.LCID.ToLower() == "ru").Translation_Data
                    ,

                    TitleZh = s.prtl_menu_univ_trans.SingleOrDefault(t => t.prtl_Language.LCID.ToLower() == "zh").Translation_Data
            ...
            {
                var menuItems = from mt in dc.prtl_menu_medias
                                orderby mt.Parent_id, mt.Order
                                where mt.Published && mt.Position == position
                                && (mt.Owner_ID.GetValueOrDefault(Guid.Empty) == ownerID.GetValueOrDefault(Guid.Empty)
                                || mt.Owner_ID == null)
                ...
                return menuItems.Select(s => new XMLMenuItem
                {
                    ...
                    Url_target = s.Url_target
                    ,
                    TitleAr = s.prtl_menu_media_trans.First(t => t.prtl_Language.LCID == "ar").Translation_Data
                    ,
                    TitleEn = s.prtl_menu_media_trans.First(t => t.prtl_Language.LCID == "en").Translation_Data
            ...
            {
                var menuItems = from mt in dc.prtl_menu_AIs
                                orderby mt.Parent_id, mt.Order
                                where mt.Published && mt.Position == position
                                && (mt.Owner_ID.GetValueOrDefault(Guid.Empty) == ownerID.GetValueOrDefault(Guid.Empty)
                                || mt.Owner_ID == null)
                ...
                return menuItems.Select(s => new XMLMenuItem
                {
                    ...
                    Url_target = s.Url_target
                    ,
                    TitleAr = s.prtl_menu_AI_trans.First(t => t.prtl_Language.LCID == "ar").Translation_Data
                    ,
                    TitleEn = s.prtl_menu_AI_trans.First(t => t.prtl_Language.LCID == "en").Translation_Data
            ...
            {
                var menuItems = from mt in dc.prtl_menu_dents
                                orderby mt.Parent_id, mt.Order
                                where mt.Published && mt.Position == position
                                && (mt.Owner_ID.GetValueOrDefault(Guid.Empty) == ownerID.GetValueOrDefault(Guid.Empty)
                                || mt.Owner_ID == null)
                ...
                return menuItems.Select(s => new XMLMenuItem
                {
                    ...
                    Url_target = s.Url_target
                    ,
                    TitleAr = s.prtl_menu_dent_trans.First(t => t.prtl_Language.LCID == "ar").Translation_Data
                    ,
                    TitleEn = s.prtl_menu_dent_trans.First(t => t.prtl_Language.LCID == "en").Translation_Data
        ...
        public static prtl_menu_AI Insert_ai_MenuItem(prtl_menu_AI menuitem)
        {
            var dc = new PortalDataContextDataContext();

            dc.prtl_menu_AIs.InsertOnSubmit(menuitem);
            dc.SubmitChanges();
            return menuitem;
        }
        ...
        //16-6-2022
        public static prtl_menu_dent Insert_dent_MenuItem(prtl_menu_dent menuitem)
        {
            var dc = new PortalDataContextDataContext();
            dc.prtl_menu_dents.InsertOnSubmit(menuitem);
            dc.SubmitChanges();
            return menuitem;
        }
        //12121212
        ...
        public static void Update_ai_MenuItem(Guid tr, Func<prtl_menu_AI, prtl_menu_AI> func)
        {
            var dc = new PortalDataContextDataContext();
            {
                var menuItem = func(dc.prtl_menu_AIs.Single(m => m.Translation_ID == tr));
                dc.SubmitChanges();
            }
        }
        ...
        //16-6-2022
        public static void Update_dent_MenuItem(Guid tr, Func<prtl_menu_dent, prtl_menu_dent> func)
        {
            var dc = new PortalDataContextDataContext();
            {
                var menuItem = func(dc.prtl_menu_dents.Single(m => m.Translation_ID == tr));
                dc.SubmitChanges();
            }
        }
        //12121212
        ...
        public static bool GetPublishedState(string MenuId, string abbr)
        {
            ...
            {
                var q = new PortalDataContextDataContext().prtl_menu_medias.SingleOrDefault(x => x.Translation_ID.ToString() == MenuId);
            ...
            {
                var q = new PortalDataContextDataContext().prtl_menu_AIs.SingleOrDefault(x => x.Translation_ID.ToString() == MenuId);
            ...
            {
                var q = new PortalDataContextDataContext().prtl_menu_dents.SingleOrDefault(x => x.Translation_ID.ToString() == MenuId);
        ...
        public static void UpdateMenuWithPublish(int id, bool Published, [Optional] string abbr)
        {
            var dc = new PortalDataContextDataContext();
            {
                ...
                {
                    var Menu = dc.prtl_menu_medias.Single(a => a.Menu_id == id);
                    Menu.Published = Published;
                    dc.SubmitChanges();
                }
                //14-4-2022
                ...
                {
                    var Menu = dc.prtl_menu_AIs.Single(a => a.Menu_id == id);
                    Menu.Published = Published;
                    dc.SubmitChanges();
                }//16-6-2022
                else if (abbr.ToLower() == "dent")
                {
                    var Menu = dc.prtl_menu_dents.Single(a => a.Menu_id == id);
                    Menu.Published = Published;
                    dc.SubmitChanges();
                }
                else
        ...
        public static string GetParentidValues(Guid tid, string currentlanguage, string abbr)
        {
            ...
            {
                var prtlMenuMedaiaTran = dc.prtl_menu_media_trans.SingleOrDefault(
                    x => x.Translation_ID == tid && x.prtl_Language.LCID == currentlanguage);
                if (prtlMenuMedaiaTran != null)
                {
                    return prtlMenuMedaiaTran
            ...
            {
                var prtlMenuMedaiaTran = dc.prtl_menu_AI_trans.SingleOrDefault(
                    x => x.Translation_ID == tid && x.prtl_Language.LCID == currentlanguage);
                if (prtlMenuMedaiaTran != null)
                {
                    return prtlMenuMedaiaTran
        ...
        public static string GetOrder(Guid tid, string currentlanguage, string abbr)
        {
            ...
            {
                var q = dc.prtl_menu_media_trans.SingleOrDefault(
                x => x.Translation_ID == tid && x.prtl_Language.LCID == currentlanguage);
                if (q != null)
                {
                    return q.prtl_menu_media.Order.ToString();
                }
                else
                {
                    return "0";
            ...
            {
                var q = dc.prtl_menu_AI_trans.SingleOrDefault(
                x => x.Translation_ID == tid && x.prtl_Language.LCID == currentlanguage);
                if (q != null)
                {
                    return q.prtl_menu_AI.Order.ToString();
                }
                else
                {
                    return "0";
            ...
            {
                var q = dc.prtl_menu_dent_trans.SingleOrDefault(
                x => x.Translation_ID == tid && x.prtl_Language.LCID == currentlanguage);
                if (q != null)
                {
                    return q.prtl_menu_dent.Order.ToString();
                }
                else
                {
                    return "0";
        ...
        public static string GetURL(Guid tid, string currentlanguage, string abbr)
        {
            ...
            {
                var prtlMenuMediaTran = dc.prtl_menu_media_trans.SingleOrDefault(
                    x => x.Translation_ID == tid && x.prtl_Language.LCID == currentlanguage);
                if (prtlMenuMediaTran != null)
                {
                    return
                        prtlMenuMediaTran
                            .prtl_menu_media.Url;
            ...
            {
                var prtlMenuMediaTran = dc.prtl_menu_AI_trans.SingleOrDefault(
                    x => x.Translation_ID == tid && x.prtl_Language.LCID == currentlanguage);
                if (prtlMenuMediaTran != null)
                {
                    return
        ...
        public static string GetRoles(Guid tid, string currentlanguage, string abbr)
        {
            ...
            else if (abbr.ToLower() == "media")
            {
                ...
                if (prtlMenuMediaTran != null)
                {
                    return
                        prtlMenuMediaTran
                            .prtl_menu_media.Roles.ToString();
                }
                else
                {
                    return "";
        ...
        public static string GetPosition(Guid tid, string currentlanguage, string abbr)
        {
            ...
            else if (abbr.ToLower() == "media")
            {
                ...
                if (prtlMenuMediaTran != null)
                {
                    return
                        prtlMenuMediaTran
                            .prtl_menu_media.Position.ToString();
                }
                else
                {
                    return "";
            ...
            else if (abbr.ToLower() == "ai")
            {
                ...
                if (prtlMenuMediaTran != null)
                {
                    return
                        prtlMenuMediaTran
                            .prtl_menu_AI.Position.ToString();
                }
                else
                {
                    return "";
            ...
            else if (abbr.ToLower() == "dent")
            {
                ...
                if (prtlMenuComTran != null)
                {
                    return
                        prtlMenuComTran
                            .prtl_menu_dent.Position.ToString();
                }
                else
                {
                    return "";
        ...
        public static bool GetPublished(Guid tid, string currentlanguage, string abbr)
        {
            ...
            else if (abbr.ToLower() == "media")
            {
                var prtlMenuMediaTran = dc.prtl_menu_media_trans.SingleOrDefault(
                    x => x.Translation_ID == tid && x.prtl_Language.LCID == currentlanguage);
                return
               prtlMenuMediaTran != null && prtlMenuMediaTran
                       .prtl_menu_media.Published;
            }
            else if (abbr.ToLower() == "ai")
            {
                var prtlMenuMediaTran = dc.prtl_menu_AI_trans.SingleOrDefault(
        ...
        public static string GetMenuId(Guid tid, string currentlanguage, string abbr)
        {
            ...
            else if (abbr.ToLower() == "media")
            {
                ...
                if (prtlMenuMediaTran != null)
                {
                    return prtlMenuMediaTran
                        .prtl_menu_media.Menu_id.ToString();
                }
                else
                {
                    return "0";
            ...
            else if (abbr.ToLower() == "dent")
            {
                ...
                {
                    return prtlMenuComTran
                        .prtl_menu_dent.Menu_id.ToString();
                }
                else
                {
                    return "0";
