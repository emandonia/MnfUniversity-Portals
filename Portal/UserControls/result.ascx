<%@ Control Language="C#" AutoEventWireup="true" CodeFile="result.ascx.cs" Inherits="result" %>
...
<p>
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:الأولى  2014المحموعةConnectionString %>" ProviderName="<%$ ConnectionStrings:الأولى  2014المحموعةConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [TFinal Results] WHERE (([AcdNumber] = ?) AND ([depart] = ?))">
        <SelectParameters>
