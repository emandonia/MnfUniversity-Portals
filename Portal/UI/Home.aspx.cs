    ...
    public partial class Home : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           //  OwnerImageFormView.CssClass="table1111";
            ...
            else if (StaticUtilities.Currentlanguage(Page) == "fr")
            {
                //  OwnerImageFormView.CssClass="table1111";
            ...
            if (abbr == null)
            {
                NewsViewerControl1.TopNewsCounter = 4;
                NewsViewerControl2.Visible = true;
            }
            else
            {
                NewsViewerControl1.TopNewsCounter = 8;
                NewsViewerControl2.Visible = false;
            }
        ...
        protected void Button555_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("http://" + Request.Url.Authority +"/"+URLBuilder.CurrentOwnerAbbr(Page.RouteData)+ "/News/" + StaticUtilities.Currentlanguage(Page));
            }
        }
        ...
        //{
        //   //  MembershipUser user = StaffUsers_Utility.GetMemberShipUser(4746);
        //  //  var query2 = (from xx in dc.aspnet_Users where xx.UserId == query.User_ID select xx).SingleOrDefault();
        //    MembershipUser user = Membership.GetUser("superadmin");
