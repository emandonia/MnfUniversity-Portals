<%@ Page Language="C#" MasterPageFile="~/Masterpages/UniversityMaster.Master" AutoEventWireup="true" CodeBehind="SubjectHome.aspx.cs" Inherits="MnfUniversity_Portals.UI.SubjectHome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
  ...
  ga('send', 'pageview');
   ...
   <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
       ...
       <ContentTemplate>
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="ED_SUBJECT_ID"
        ...
        <ItemTemplate>
            <tr>
                <td colspan="2" class="col1"><asp:Label ID="Label6"  runat="server" Text='<%# getsubjectDes(Eval("ED_SUBJECT_ID")) %>' Font-Bold="True" /></td>
            </tr>           
            <tr>
                <td class="col2">
            ...
            <tr>
                ...
                <td>
                    &nbsp;&nbsp;&nbsp;<asp:Label ID="LblSUBJECT_CONTENTS_AR" runat="server" Text='<%# getsubjectCont(Eval("ED_SUBJECT_ID")) %>' />
                </td>
            </tr>
            <tr>
                <td class="col2">
          ...
          <tr>
                <td class="col2"  style="text-align: center;">
                 ...
                 <td >
                    <asp:LinkButton Visible='<%# checkuser() %>' ValidationGroup="InsertValidation" CommandArgument='<%# Eval("ED_SUBJECT_ID") %>' OnClick="InsertCourseSpecsInsertClicked"
               ...
               <td >
                    <asp:LinkButton Visible='<%# checkuser() %>' ValidationGroup="InsertValidation" CommandArgument='<%# Eval("ED_SUBJECT_ID") %>' OnClick="DeleteSpecsButtonClicked"
            ...
            <tr>
                ...
                <td >
                    <asp:LinkButton Visible='<%# checkuser() %>' ValidationGroup="InsertValidation" CommandArgument='<%# Eval("ED_SUBJECT_ID") %>'    OnClick="InsertCourseReportInsertClicked"
                 ...
                 <td >
                    <asp:LinkButton Visible='<%# checkuser() %>' ValidationGroup="InsertValidation" CommandArgument='<%# Eval("ED_SUBJECT_ID") %>'    OnClick="DeleteReportButtonClicked"
    ...
    <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="Mis_DAL.MisDataContext"
        EntityTypeName="" TableName="ED_SUBJECTs">
    </asp:LinqDataSource>
    <br/>
