...
{
    public partial class AdminAdv : PageBase
    {
        ...
        protected void ButtonAddOnCommand(object sender, CommandEventArgs e)
        {
            if (e.CommandName == "Add")
            {
                ...
                Adv x = new Adv();
                AsyncFileUpload insertFileUpload = (AsyncFileUpload)DetailsView1.FindControl("insertFileUpload");
                if (insertFileUpload.HasFile)
                {
                    string filename = StaticUtilities.UploadImage00(DetailsView1, "insertFileUpload", SiteFolders.Advertisement);
                    x.Image = insertFileUpload.FileName;
                }else
                {
                    x.Image = "Not Found";
                }
        ...
        protected void DetailsView1_OnItemUpdating(object sender, DetailsViewUpdateEventArgs e)
        {
            ...
            AsyncFileUpload EditeFileUpload = (AsyncFileUpload)DetailsView1.FindControl("EditeFileUpload");
            string fileName = "";
