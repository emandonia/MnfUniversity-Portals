    ...
    public partial class AdminPreferences : PageBase
    {
        ...
        protected void InsertStandardPasswordInformButton_OnClick(object sender, EventArgs e)
        {
           txtActualContent1.Text=
                    ...
                    "<br/>To change your details shown in your CV please log in to http://193.227.24.15/staff_stf/ then search for your name in arabic then insert your National ID." +
