   ...
   <%-- <section class="content-box box-1" >
               ...
               <section class="content-box box-1">
                <div class="row" id="xx">
                    <div class="pre_bg">
                        ...
                        <div class="col-1-1">
                            <div class="wrap-col item">
                                <div class="div_image">
                                    <div class="circle-border zoom-in">
                                        <img class="img-circle" src="../Styles/University_Master/images/drKased.png" alt="graduat">
                                    </div>
                                    <a href="../Styles/University_Master/images/CVDrKased.pdf" target="_blank">
                                        <asp:Label ID="Label5" CssClass="h_style" runat="server" meta:resourcekey="gra"></asp:Label>
                                        <asp:Label ID="Label6" CssClass="p_style" runat="server" meta:resourcekey="title1"></asp:Label>
                                    </a>
                                </div>
                            </div>
                        </div>
                 ...
                 <div class="row" id="xx2">
                    <div class="pre_bg">
                          <div class="col-1-4">
<div class="wrap-col item">
     <div class="div_image">
    <div class="circle-border zoom-in">
        <img class="img-circle" src="../Styles/University_Master/images/drEkramy.jpeg" alt="community">
    </div>
         ...
         <asp:Label ID="Label8" CssClass="p_style" runat="server" meta:resourcekey ="title2"></asp:Label>
                   ...
                   <%--     <div class="col-1-3">
                            <div class="wrap-col item">
                                <div class="div_image">
                                    <div class="circle-border zoom-in">
                                        <img class="img-circle" src="../Styles/University_Master/images/drhazem.jpg" alt="community">
                                    </div>

                                    <asp:Label ID="Label11" CssClass="h_style" runat="server" meta:resourcekey="comm2"></asp:Label>
                                    <asp:Label ID="Label12" CssClass="p_style" runat="server" meta:resourcekey="title3"></asp:Label>
                                </div>
                            </div>
                        </div>--%>
                        ...
                        <div class="col-1-3">
                            <div class="wrap-col item">
                                <div class="div_image">
                                    <div class="circle-border zoom-in">
                                        <img class="img-circle" src="../Styles/University_Master/images/drSobhy.JPEG" alt="community" />
                                    </div>

                                    <a href="../Styles/University_Master/السيرة الذاتية د. صبحي شرف عميد الكلية 13-3 - Copy.pdf" target="_blank">
                                        <asp:Label ID="Label13" CssClass="h_style" runat="server" meta:resourcekey="comm44"></asp:Label>
                                        <asp:Label ID="Label14" CssClass="p_style" runat="server" meta:resourcekey="title4"></asp:Label></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-1-3">
                            <div class="wrap-col item">
                                <div class="div_image">
                                    <div class="circle-border zoom-in">
                                        <img class="img-circle" src="../Styles/University_Master/images/student.jpeg" alt="student">
                                    </div>

                                    <asp:Label ID="Label15" CssClass="h_style" runat="server" meta:resourcekey="stu"></asp:Label>
                                    
                                    <asp:Label ID="Label17" CssClass="p_style" runat="server" meta:resourcekey="stutitle2"></asp:Label>
                                    <%--<asp:Label ID="Label16" CssClass="p_style" runat="server" meta:resourcekey="title2"></asp:Label>--%>
                                </div>
                            </div>
                        </div>
                    </div>
