<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Abstracts.aspx.cs" MasterPageFile="~/Masterpages/UniversityMaster.master" Inherits="MnfUniversity_Portals.UI.Abstracts" %>

<asp:Content ID="Content1" ContentPlaceHolderID="meta" runat="Server">

    <meta http-equiv="Content-Type" content="مستخلصات ابحاث اعضاء هيئة التدريس بجامعة المنوفية , menofia university staff abstracts" />
</asp:Content>
...
<tr>
<td><asp:Label ID="Label1" runat="server" style="font-size:17px; font-weight:bold;" Text="Choose Faculty:" meta:resourcekey="Fac"></asp:Label></td>
<td> <asp:DropDownList AppendDataBoundItems="true" AutoPostBack="True" CssClass="textboxservice2" DataSourceID="ObjectDataSource1" DataTextField="Faculty_Name" DataValueField="ID" ID="FacDropDownList" OnSelectedIndexChanged="FacDropDownList_SelectedIndexChanged" runat="server">
<asp:ListItem Value="-1" Text="choose" style="font-size:17px; font-weight:bold;">اختر</asp:ListItem>
</asp:DropDownList>
...
<asp:ListView ID="AbstractListView" runat="server" InsertItemPosition="FirstItem">
<InsertItemTemplate>
<tr>
<td colspan="6">
<asp:LinkButton Visible='<%#checkuser() %>' ValidationGroup="InsertValidation" CommandArgument='<%# Eval("SA_STF_MEMBER_ID") %>' OnClick="FileAbstractEditorControlInsertClicked" ID="InsertLinkButton" ToolTip="Insert" runat="server" AlternateText="Insert" Font-Size="Large" ForeColor="Blue">
...
<ItemTemplate>
<tr runat="server" id="ListViewDataRow" style="height:30px; background-color:#b7d6ee;" align="center">
<td>
...
<table id="itemPlaceholderContainer" runat="server" style="border:2px solid #ffffff;font-size:15px; font-weight:bold;" >
<tr id="Tr2" runat="server" style="height:40px; background-color:#074982;color:#ffffff;">
<th id="Th3" runat="server" style="background-color:#074982;">
<asp:Label ID="Label5" runat="server" Text="Staff Arabic Name"></asp:Label>
</th>
<th id="Th1" runat="server" style="background-color:#074982;">
<asp:Label ID="Label6" runat="server" Text="Staff English Name"></asp:Label>
</th>
<th id="Th2" runat="server" style="background-color:#074982;">
...
<asp:DetailsView ID="Editor_DetailsView1" CssClass="Editor_DetailsView" runat="server" AllowPaging="True" AutoGenerateRows="False" CellPadding="4" GridLines="None" EmptyDataText="No Data">
<Fields>
...
<InsertItemTemplate>
<ajaxtk:AsyncFileUpload ID="AsyncFileUpload1" runat="server" PersistFile="True" PersistedStoreType="Session" Width="70px"></ajaxtk:AsyncFileUpload>
</InsertItemTemplate>
</asp:TemplateField>
</Fields>
<FooterTemplate>
