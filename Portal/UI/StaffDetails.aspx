...
<%--<img id="Img1" alt="Image" runat="server" width="120" height="120" src='http://193.227.24.15/umisbuilt_new'+'<%#GetImageUrl(Page)%>' />--%>
    <img id="Img2" alt="Image" runat="server" width="120" height="120" src='<%# "http://193.227.24.15/umisbuilt_new" + GetImageUrl(Page) %>' />
</div><br/>
...
<td>
    <%--<asp:Label ID="Label34" runat="server" Visible='<%#checkEmail() %>' Text="البريد الالكتروني:" meta:resourcekey="Em"></asp:Label>--%>

<asp:Label ID="Label35" runat="server"  Text="البريد الالكتروني:" meta:resourcekey="Em"></asp:Label>
</td>
<td>
    &nbsp;&nbsp;&nbsp;<asp:Label ID="Label36" runat="server" Text='<%# Staff_Utility.GetSpecDetail(Eval("SA_STF_MEMBER_ID"),2) %>' />
