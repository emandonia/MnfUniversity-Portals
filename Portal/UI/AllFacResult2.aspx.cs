...
{
    public partial class AllFacResult2 : PageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Session["fac_datasource2"] != null)
                {
                    if (Session["fac"] != null)
                    {
                        if ((int)Session["fac"] != 0)
                        {
                            ...
                            DropDownList1.DataSource = (Dictionary<string, decimal>)Session["fac_datasource2"];
                ...
                else
                {
                    if (Session["fac"] != null)
                    {
                        if ((int)Session["fac"] != 0)
                        {
                            ...
                            DropDownList1.DataSource = ResultsUtility.GetFaculties_2();
                            DropDownList1.DataTextField = "key";
                            DropDownList1.DataValueField = "Value";
        ...
        {
            Session["fac_datasource2"] = ResultsUtility.GetFaculties_2();
